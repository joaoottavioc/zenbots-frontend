  ...
  theme: {
  	...
  	extend: {
  		...
  		animation: {
  			...
  			'hero-drift-1': 'hero-drift-1 16s ease-in-out infinite',
  			'hero-drift-2': 'hero-drift-2 20s ease-in-out infinite',
  			'hero-drift-3': 'hero-drift-3 14s ease-in-out infinite',
  			'message-in': 'message-in 0.4s ease-out forwards',
  			'cartoon-pop': 'cartoon-pop 0.5s cubic-bezier(0.34,1.56,0.64,1) forwards',
  			'draw-arrow': 'draw-arrow 0.6s ease-out forwards',
  			'emoji-pop': 'emoji-pop 0.6s ease-in-out infinite',
